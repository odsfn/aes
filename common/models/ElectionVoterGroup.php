...
class ElectionVoterGroup extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('election_id, voter_group_id', 'required'),
            array('election_id, voter_group_id', 'numerical', 'integerOnly'=>true),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, election_id, voter_group_id', 'safe', 'on'=>'search'),
        );
    }
