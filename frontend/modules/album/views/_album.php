...
<div class="row">
    В альбоме <?php echo $nphotos; ?> фотографий
</div>
...
<div id="replace_container">
  ...
  <?php foreach($photos as $page => $photo):?>
    ...
    echo CHtml::link( 
        CHtml::tag('img', array(
            'src'=> (
                $photo->path ? $this->getModule()->getComponent('image')->createAbsoluteUrl('100x100', $photo->path) : $this->getModule()->getAssetsUrl('img/no_album.png')
            ))), 
        array(
