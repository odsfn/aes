...
class UserVotesTest extends WebTestCase {
    ...
    public function testShowVotes() {
        ...
        $this->waitForCssCount('css=#votes-feed-container > div > div.items > div', 2);
        $this->waitForCssCount('css=#votes-feed-container > div > div.items > div:nth-of-type(2) .votes-container > div > div a', 4, 5000);
        ...
        $this->assertElementContainsText('css=#votes-feed-container > div > div.items > div:nth-of-type(2) .votes-container > div > div:nth-of-type(2) a', '№3 Jhon Lenon');
        $this->assertElementContainsText('css=#votes-feed-container > div > div.items > div:nth-of-type(2) .votes-container > div > div:nth-of-type(2) span.label', 'Declined');
        $this->assertElementContainsText('css=#votes-feed-container > div > div.items > div:nth-of-type(2) .votes-container > div > div:nth-of-type(3) a', '№1 Another User');
        $this->assertElementContainsText('css=#votes-feed-container > div > div.items > div:nth-of-type(2) .votes-container > div > div:nth-of-type(3) span.label', 'Revoked');
        $this->assertElementContainsText('css=#votes-feed-container > div > div.items > div:nth-of-type(2) .votes-container > div > div:nth-of-type(4) a', '№1 Another User');
        $this->assertElementContainsText('css=#votes-feed-container > div > div.items > div:nth-of-type(2) .votes-container > div > div:nth-of-type(4) span.label', 'Revoked');
        
        $this->waitForCssCount('css=#votes-feed-container > div > div.items > div:nth-of-type(1) .votes-container > div > div a', 1);
        $this->assertElementContainsText('css=#votes-feed-container > div > div.items > div:nth-of-type(1) h4', 'Election 1');
        $this->assertElementContainsText('css=#votes-feed-container > div > div.items > div:nth-of-type(1) .votes-container > div > div:nth-of-type(1) a', '№2 Vasiliy Pedak');    
    }
}
